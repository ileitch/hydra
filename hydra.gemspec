...
Gem::Specification.new do |s|
  ...
  s.files = [
    ".document",
     ...
     "lib/hydra/spec/rspec1/autorun_override.rb",
     "lib/hydra/spec/rspec1/hydra_formatter.rb",
     "lib/hydra/spec/rspec2/autorun_override.rb",
     "lib/hydra/spec/rspec2/hydra_formatter.rb",
     "lib/hydra/ssh.rb",
     "lib/hydra/stdio.rb",
     "lib/hydra/sync.rb",
     "lib/hydra/tasks.rb",
